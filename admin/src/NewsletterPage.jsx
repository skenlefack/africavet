...
marie@example.com,Marie,Dupont,fr"
  ...
  const NewsletterEditor = () => {
    ...
    const generateHtmlFromBlocks = () => {
      ...
      const siteUrl = 'https://africavet.com';
      // Backend URL for serving images (uploads)
      const backendUrl = window.location.hostname === 'localhost'
        ? 'http://localhost:5001'
        : siteUrl;

      // AfricaVet logo as embedded base64 JPG (works reliably in all email clients)
      ...
      if (selectedTemplate && selectedTemplate.content_html_fr) {
        ...
        html = html.replace(/src=["']?\{\{site_url\}\}\/images\/favicon\.png["']?/g, `src="${logoUrl}"`);
        html = html.replace(/src=["']?https:\/\/africavet\.com\/images\/favicon\.png["']?/g, `src="${logoUrl}"`);
...
<body>
  <div class="wrapper">
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          ...
          <td valign="middle" style="padding-left: 15px;">
            <h1 style="color: white; margin: 0; font-size: 22px; font-weight: 700;">AfricaVet</h1>
            <p style="color: #a7f3d0; margin: 3px 0 0; font-size: 12px;">Plateforme Vétérinaire Panafricaine</p>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="footer">
      <p>&copy; ${new Date().getFullYear()} AfricaVet. Tous droits reserves.</p>
      ...
      <div style={{ display: 'grid', gap: '20px', maxWidth: '600px' }}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="newsletter@africavet.com"
          />
        </div>
        <div>
          <label style={{ display: 'block', marginBottom: '6px', fontSize: '13px', fontWeight: '600', color: isDark ? '#94a3b8' : '#64748b' }}>
          ...
          <input
            ...
            placeholder="contact@africavet.com"
          />
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          <div>
