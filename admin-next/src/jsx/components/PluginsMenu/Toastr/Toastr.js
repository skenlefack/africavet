            ...
            <div className="card">
              ...
              <div className="card-body">
                <button
                  ...
                  type="button"
                  className="btn mb-2 me-2 btn-secondary light"
                ...
                <button
                  ...
                  type="button"
                  className="btn btn-secondary mb-2  me-2 light"
                ...
                <button
                  onClick={notifyInfo}
                  type="button"
                  className="btn btn-info mb-2  me-2 light"
                ...
                <button
                  ...
                  type="button"
                  className="btn btn-warning mb-2  me-2 light"
                ...
                <button
                  onClick={notifyError}
                  type="button"
                  className="btn btn-danger mb-2  me-2  light"
