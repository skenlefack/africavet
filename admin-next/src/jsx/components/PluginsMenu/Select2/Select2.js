            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <button className="btn btn-primary light" id="js-programmatic-disable">
                    Disable
                  </button>
                </div>
              </div>
            ...
            <div className="col-xl-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <button id="destroy-selector-trigger" className="btn btn-primary light">
                    Destroy Select2
                  </button>
                </div>
              </div>
            ...
            <div className="col-xl-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <button id="dropdown-trigger-open" className="btn btn-primary light ">
                    Open Dropdown
                  </button>
                </div>
              </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <button
                    ...
                    className="btn btn-primary light mb-2 me-1"
                  >
                    Open Dropdown
                  </button>
                  <button
            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <br />
                  <button
                    className="js-programmatic-set-val btn btn-primary light mb-2 me-1"                    
                  >
                    Set "California"
                  </button>
                  <button className="js-programmatic-open btn btn-primary light mb-2 me-1">
                    Open
                  </button>
                  <button className="js-programmatic-close btn btn-primary light mb-2 me-1">
                    btn-close
                  </button>
                  <button className="js-programmatic-destroy btn btn-primary light mb-2 me-1">
                    Destroy
                  </button>
                  <button className="js-programmatic-init btn btn-primary light  mb-2 me-1">
                    Re-initialize
                  </button>
                  <div className="mt-4">
                    <CustomSelete />
            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-body ">
                  ...
                  <br />
                  <button
                    className="js-programmatic-multi-set-val btn btn-primary light mb-2 me-1"
                    aria-label="Set Select2 option"
                  >
                    Set to Hawaii and California
                  </button>
                  <button className="js-programmatic-multi-clear btn btn-primary light mb-2 me-1">
                    Clear
                  </button>
                  <div className="mt-4">
