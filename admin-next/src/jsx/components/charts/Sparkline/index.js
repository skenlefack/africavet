    ...
    <>      
        ...
        <Row>
            ...
            <Card>
              ...
              <Card.Body>
                <Sparklines data={sampleData}>
                  <SparklinesLine color="var(--primary-light)" />
                </Sparklines>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col xl={6} lg={6}>
            <Card>
              ...
              <Card.Body>
                <Sparklines data={sampleData}>
                  <SparklinesLine color="var(--primary-light)"  />
                  <SparklinesReferenceLine type="mean" color="var(--primary-light) "/>
                </Sparklines>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col xl={6} lg={6}>
            <Card>
              ...
              <Card.Body>
                <Sparklines data={sampleData}>
                  <SparklinesLine color="var(--primary-light)"  style={{ fill: "none" }} />
                  <SparklinesSpots />
                </Sparklines>
              </Card.Body>
            </Card>
          ...
          <Col xl={6} lg={6}>
            <Card>
              ...
              <Card.Body>
                <Sparklines data={sampleData}>
                  <SparklinesLine color="var(--primary-light) " />
                  <SparklinesSpots style={{ fill: "var(--primary-light) " }} />
                </Sparklines>
              </Card.Body>
            </Card>
          </Col>
      <Col xl={6} lg={6}>
            <Card>
              ...
              <Card.Body>
                <Sparklines data={sampleData} >
          <SparklinesBars style={{ fill: 'var(--primary-light)', fillOpacity: ".6" }} />
          <SparklinesReferenceLine />
        </Sparklines>
              </Card.Body>
            </Card>
          ...
          <Col xl={6} lg={6}>
            <Card>
              ...
              <Card.Body>
                ...
                >
                  <SparklinesBars style={{ fill: "var(--primary-light)" }} />
                </Sparklines>
              </Card.Body>
            </Card>
          </Col>
