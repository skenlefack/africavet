  ...
  return (
                  ...
                  <Col lg="12">
                    <Tab.Container defaultActiveKey="Preview"> 
                      <Card ref={(el) => allRefs(el)} className="dz-card">
                        <Card.Header className="border-0 d-flex justify-content-between flex-wrap">
                          <div>
                    ...
                    <Tab.Container defaultActiveKey="Preview"> 
                      <Card ref={(el) => allRefs(el)} className="dz-card">
                        ...
                        <Tab.Content> 
                          <Tab.Pane eventKey="Preview">
                            <div className="card-body">
                            <Button className="me-2" variant="primary btn-lg light">
                              Large Button
                            </Button>
                            <Button className="me-2" variant="primary light btn-md">
                              Medium Button
                            </Button>
                            <Button className="me-2" variant="primary light">
                              Default Button
                            </Button>
                            <Button className="me-2" variant="primary btn-sm light">
                              Small Button
                            </Button>
                              <Button variant="primary btn-xs light">Extra Small Button</Button>
                            </div>
                          </Tab.Pane>
                          <Tab.Pane eventKey="Code">
                          <div className="card-body pt-0 p-0 code-area">
                    ...
                    <Tab.Container defaultActiveKey="Preview"> 
                      <Card ref={(el) => allRefs(el)} className="dz-card">
                        ...
                        <Tab.Content> 
                          <Tab.Pane eventKey="Preview">
                            <div className="card-body">
                              <Button className="me-2" variant="primary btn-icon-lg light">
                              <i className="fa-solid fa-house-chimney" />
                              </Button>
                              <Button className="me-2" variant="primary btn-icon-md light">
                              <i className="fa-solid fa-house-chimney" />
                              </Button>
                              <Button className="me-2" variant="primary btn-icon-sm light">
                                <i className="fa-solid fa-house-chimney" />
                              </Button>
                              <Button className="me-2" variant="primary btn-icon-xs light">
                                  <i className="fa-solid fa-house-chimney" />
                              </Button>
                              <Button variant="primary btn-icon-xxs light"><i className="fa-solid fa-house-chimney" /></Button>
                            </div>
                          </Tab.Pane>
                          <Tab.Pane eventKey="Code">
                          <div className="card-body pt-0 p-0 code-area">
    ...
    <Highlight>
      ...
      <div className="card-body">
        ...
        <Button className="me-2" variant="primary btn-icon-xs v">
            <i className="fa-solid fa-house-chimney" />
        </Button>
        <Button variant="primary btn-icon-xxs light"><i className="fa-solid fa-house-chimney" /></Button>
      </div>
                        ...
                        <Tab.Content> 
                          <Tab.Pane eventKey="Preview">
                            <div className="card-body">
                              ...
                              <Button className="me-2" variant="primary btn-rounded light">
                                Primary
                              </Button>
                    ...
                    <Tab.Container defaultActiveKey="Preview"> 
                      <Card ref={(el) => allRefs(el)}className="dz-card">
                        ...
                        <Tab.Content> 
                          <Tab.Pane eventKey="Preview">
                            <div className="card-body">
                              <Button className="me-2" variant="primary btn-square light">
                                Primary
                              </Button>
                        ...
                        <Tab.Content> 
                          <Tab.Pane eventKey="Preview">
                            <div className="card-body">
                              <ButtonGroup>
                                <Dropdown>
                                  <Dropdown.Toggle className="me-2" variant="primary light">
                                    Primary
                                  </Dropdown.Toggle>
                                  <Dropdown.Menu>
      ...
      `}
          ...
          <div className="demo-right ">
            <div className="demo-right-inner dlab-scroll" id="right-sidebar">
              <h4 className="title mb-2">Button</h4>
