  ...
  return (
    ...
    `}
                      ...
                      <Col xl={12}>
                        <Tab.Container defaultActiveKey="Preview">
                              <Card ref={(el) => allRefs(el)} className="dz-card">
                                <Card.Header className="d-flex border-0 justify-content-between flex-wrap">
                                  <div>
                                ...
                                <Tab.Pane eventKey="Preview">
                                  <Card.Body>
                                      ...
                                      <Alert  variant="dark" dismissible show={state.linkdark}>               
                                          <strong>WOW! Eveything looks OK. </strong>
                                          <Link to={"#"} className="text-light">Click here for details. <button className="btn-close" onClick={()=>dispatch({type:'linkdark'})}><span><i className="fa-solid fa-xmark"></i></span></button></Link>
                                      </Alert>
                                  ...
                                  <Row>                         
                                    <Col xl={6}>
                                      <Alert  variant="primary"  className="notification">
                                          ...
                                          <Button variant="link" size="sm" className="link-secondary">
                                              Cancel
                                          </Button>
                                      </Alert>
                                    </Col>
                                ...
                                <Tab.Pane eventKey="Preview">
                                  <Card.Body>             
                                      ...
                                      <Alert  variant="light" dismissible show={state.outlinelight} className="alert-outline-light">						
                                        <strong>Error!</strong> {" "} Error! Message Sending failed..
      ...
      `}
                ...
                <div className="demo-right ">
                    <div className="demo-right-inner dlab-scroll " id="right-sidebar">
                        <h4 className="title mb-2">Alert</h4>
