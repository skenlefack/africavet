...
const sidebarData = [
  {title: 'Default', to:'accordion-one', select:''},
  {title: 'Bordered', to:'accordion-two', select:''},
  {title: 'Without Space', to:'accordion-three', select:''},
  {title: 'Without Space with Border', to:'accordion-four', select:''},
  {title: 'Indicator in left position', to:'accordion-five', select:''},
  {title: 'With Icon', to:'accordion-six', select:''},
  {title: 'Header Background', to:'accordion-seven', select:''},
  {title: 'Solid Background', to:'accordion-eight', select:''},
  {title: 'Active Background', to:'accordion-nine', select:''},
  {title: 'Header Shadow', to:'accordion-ten', select:''},
  {title: 'Rounded Stylish', to:'accordion-eleven', select:''},
  {title: 'Gradient', to:'accordion-twelve', select:''},
  ...
  `}                                      
              ...
              <div className="demo-right ">                
                <div className="dlab-scroll demo-right-inner  navigation navbar">    
                    <h4 className="title mb-2">Accordion</h4>
                        ...
                        {sidebarData.map((item, index)=>(
                          <li key={index} className={`${index === activeLink ? 'active' :  ''} `}>
                            <Link to={"#"}                                
                                ...
                                onClick={() => { scrooBtn(index); setActiveLink(index) }}                              
                            >
                              {item.title}
                            </Link>
                          </li>
