                              ...
                              <Tab.Pane eventKey="Preview">
                                <Card.Body>
                                  <div className="bootstrap-badge">
                                    ...
                                    <Badge bg="badge-lg" className='badge-danger badge-lg light'>Danger</Badge>
                                    <Badge bg="badge-xl " className='badge-warning badge-xl light'>Warning</Badge>
                                  </div>
                                </Card.Body>
                              </Tab.Pane>
  ...
  <Highlight>
    ...
    `}
            ...
            <div className="demo-right ">
              <div className="demo-right-inner dlab-scroll navigation navbar">
                  <h4 className="title mb-2">Badge</h4>
