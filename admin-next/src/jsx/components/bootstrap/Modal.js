			...
			<Col>
				...
				<Card.Body>
					...
					<div className="bootstrap-modal">
						...
						<Button variant="primary light" className="mb-2 me-1" onClick={() => dispatch({type:'basicModal'})}>
							Basic modal
						</Button>
						
						{/* <!-- Button trigger modal --> */}
						<Button variant="primary light" className="mb-2 me-1" onClick={() =>dispatch({type:'contentModal'})}>Long content Modal</Button>
						
						{/* <!-- Button trigger modal --> */}
						<Button variant="primary light" type="button" className="mb-2 me-1" onClick={() => dispatch({type:'modalCentered'})}>
							Modal centered
						</Button>
						{/* <!-- Modal --> */}
						...
						{/* <!-- Button trigger modal --> */}
						<Button variant="primary light" className="mb-2 me-1" onClick={() => dispatch({type:'modalWithTooltip'})}>Modal with tooltip</Button>
						{/* <!-- Modal --> */}
						

						{/* <!-- Button trigger modal --> */}
						<Button variant="primary light" className="mb-2 me-1" onClick={() => dispatch({type:'gridInsideModal'})}>Grid Inside Modal</Button>
						...
						{/* <!-- Small modal --> */}
						<Button variant="primary light" className="mb-2 me-2" onClick={() => dispatch({type:'smallModal'})}>Small modal</Button>
