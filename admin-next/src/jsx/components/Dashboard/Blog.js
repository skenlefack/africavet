...
const thirdPostBlog = [
    ...
    {image1 : IMAGES.Blogs2,  image2: IMAGES.contact3, title: "It is a long established fact"},
];
            ...
            <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="card">
                        <div className="card-header border-0">
                            <h4 className="card-title mb-0 blog-title">Active News</h4>
                            <Link to={"#"} className="btn btn-primary light btn-small">More</Link>
                        </div>
                                        ...
                                        {postDetial.map((item, index)=>(
                                            <div className="post-1" key={index}>
                                                ...
                                                <div className="post-data">
                                                    <span className={`badge border-0 light badge-sm badge-${item.theme}`}>{item.maintitle}</span>
                                                    <h4>{item.subtitle}</h4>
                                                    <div>
                ...
                <div className="col-xl-9 col-lg-7">
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header border-0">
                                    <h4 className="card-title mb-0 blog-title">Active users</h4>
                                    <Link to={"#"} className="btn btn-primary light btn-small">More</Link>
                                </div>
                                <div className="card-body pt-0">
                                    <div className="blog-img">
                        ...
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header border-0">
                                    <h4 className="card-title mb-0 blog-titl">READ MORE</h4>
                                    <Link to={"#"} className="btn btn-primary light btn-small">More</Link>
                                </div>
                                <div className="card-body pt-0">
                                    {seoToolsData.map((item, ind)=>(
                                        <div className="third-post" key={ind}>
                                            ...
                                            <div className="post-1">
                                                <div className="post-data">
                                                    <span className={`badge border-0 light badge-sm badge-${item.theme} `}>SEO Tools</span>
                                                    <h4>{item.title}</h4>
                                                    <div className="mb-2">
                                                        <img src={item.image2} className="avatar rounded-circle me-2 small-post" alt="" />
                                                        {" "}<span><b className="text-primary">{item.name}</b> in {item.date}, 2023</span>
                ...
                <div className="col-xl-3 col-lg-5">
                    <div className="card-header border-0 pt-0 px-0">
                        <h4 className="card-title mb-0 blog-title">POPULAR POSTS</h4>
                    </div>
                    <div className="recent-post">
                        <div className="blog-img style-1">
                            <img src={IMAGES.Professional} alt="" className="blk-img" />
                            <div className="blog-text">
                                <span className="badge badge-info border-0 light badge-sm mb-2">DESIGNER</span>
                                <h2>This quote highlights the importance of writing clear.</h2>
                                <img src={IMAGES.contact1} className="avatar rounded-circle me-2" alt="" />
                                <span>Hary in February 05, 2023</span>
                            </div>
                    ...
                    <div className="card-header border-0 pt-0 px-0 pb-2 ">
                        <h4 className="card-title mb-0 blog-title">SOCIAL PLUGIN</h4>
                    </div>
                    <div className="mb-4">
                        <ul className="c-social">
                            <li><Link to="https://www.facebook.com/dexignzone" target="_blank" className="bg-facebook"><i className="fa-brands fa-facebook-f"></i></Link></li>
                            <li><Link to="https://www.whatsapp.com/" target="_blank" className="bg-whatsapp"><i className="fa-brands fa-whatsapp"></i></Link></li>
                            <li><Link to="https://www.linkedin.com/in/dexignzone" target="_blank" className="bg-linkedin"><i className="fa-brands fa-linkedin-in"></i></Link></li>
                            <li><Link to="skype:rahulxarma?chat" className="bg-skype"><i className="fa-brands fa-skype"></i></Link></li>
                        </ul>
                    </div>
                            ...
                            <div className="notify-data">
                                ...
                                <form onClick={(e)=>submitHandle(e)}>
                                    <div className="mt-3">
                                        ...
                                        <Link to={"#"} className="btn btn-primary btn-small light  d-block mt-3">subscribe</Link>
                                    </div>
                                    <span className="text-start mt-2 d-block text-danger">* We promise that we don't spam !</span>
                                </form>	
                            </div>	
                        </div>
                    </div>
                    ...
                    <div className="recent-post">
                        <div className="card-header border-0 pt-0 px-0">
                            <h4 className="card-title mb-0 blog-title">Comments</h4>
                        </div>
