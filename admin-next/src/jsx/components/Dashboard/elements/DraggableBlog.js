  ...
  constructor(props) {
    ...
    this.state = {
      items: [
		...
		{id:"input2", title: 'Lorem Ipsum is simply', styleChange: 'text-success', icon: SVGICON.RightClick},
		{id:"input3", title: 'Compete this projects', styleChange: 'text-warning', icon: SVGICON.Stopboard},
		{id:"input4", title: 'Lorem Ipsum has been',styleChange: 'text-success', icon: SVGICON.RightClick},
