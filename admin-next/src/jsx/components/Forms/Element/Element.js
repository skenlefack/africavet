              ...
              <div className="card-body">
                <div className="basic-form">
                  <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button type="submit" className="btn btn-primary light"> Sign in</button>
                  </form>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                <div className="basic-form">
                  ...
                  >
                    ...
                    <button type="submit" className="btn btn-primary light mb-2">
                      Confirm identity
                    </button>
                  </form>
                </div>
                ...
                <div className="basic-form">
                  <form>            
                    <Dropdown className="input-group mb-3">
                      <Dropdown.Toggle variant="" className="btn btn-primary  light right-radius" type="button" data-toggle="dropdown">Dropdown</Dropdown.Toggle>
                      ...
                      <Dropdown className="input-group">
                        <input type="text" className="form-control left-radius-1" />
                          <Dropdown.Toggle
                            variant=""
                            className="btn btn-primary  light dropdown-toggle left-radius"
                            type="button"
                  ...
                  <form action="#">
                    <div className="input-group mb-3">
                      <SplitButton
                        ...
                        as={ButtonGroup}
                        variant="primary  light right-radius"
                    ...
                    <div className="input-group ">
                      ...
                      <SplitButton
                        ...
                        as={ButtonGroup}
                        variant="primary  light left-radius "
                        id="dropdown-button-drop-dwon"
                        // className="rounded-0"
                        drop="down"
                        title="Action"
