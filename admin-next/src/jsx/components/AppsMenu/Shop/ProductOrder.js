                ...
                <div className="card-body">
                  <div className="table-responsive">
                    <table className="table table-sm mb-0 table-responsive-lg ">
                      <thead className="text-black bg-primary-light">
                        <tr>
                      ...
                      <tbody id="orders">
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center">
                            <span className="badge badge-success light badge-sm">
                              Completed
                              <span className="ms-1 fa fa-check" />
                            </span>
                          </td>
                          <td className="py-2 text-center font-w600">$99</td>
                        ...
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center">
                            <span className="badge badge-primary light badge-sm">
                              Processing
                              <span className="ms-1 fa fa-redo" />
                            </span>
                          </td>
                          <td className="py-2 text-center font-w600">$120</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center">
                            <span className="badge badge-secondary light badge-sm">
                              On Hold
                              <span className="ms-1 fa fa-ban" />
                            </span>
                          </td>
                          <td className="py-2 text-center font-w600">$70</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center">
                            <span className="badge badge-warning light badge-sm">
                              Pending
                              <span className="ms-1 fas fa-stream" />
                            </span>
                          </td>
                          <td className="py-2 text-center font-w600">$92</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        ...
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$145</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$55</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$90</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$52</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
                        ...
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$69</td>
                          <td className="py-2 text-end">
                              <DropdonBlog />
                          </td>
                        </tr>
                        <tr className="btn-reveal-trigger">
                          ...
                          <td className="py-2 text-center font-w600">$112</td>
                          <td className="py-2 text-end">
                            <DropdonBlog />
                          </td>
                        </tr>
