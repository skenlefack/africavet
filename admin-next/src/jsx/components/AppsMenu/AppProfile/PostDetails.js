                    ...
                    <div className="card-body">
                      <div className="profile-statistics">
                        <div className="text-center">
                          ...
                          <div className="mt-4">
                            <Link	to="/post-details"	className="btn btn-primary light mb-1 me-1" onClick={() => dispatch({type:'followOpen'})}>Follow</Link>     
                            <Link to={"#"} className="btn btn-primary light mb-1 ms-1" onClick={() => dispatch({type:'sendMessageOpen'})}>Send Message</Link>
                          </div>
                        </div>
                        {/* send Modal */}
                  ...
                  <div className="card">                    
                    <div className="card-body "	>	
                      <div className="profile-blog ">
                        ...
                        <img  src={profile01}  alt="profile" className="img-fluid mt-4 rounded mb-4 w-100" />
                        ...
                        <div className="profile-news">
                          ...
                          {mediaBlog.map((item, index)=>(
                            <div className="media pt-3 pb-3" key={index}>
                              <img src={item.image} alt="proimg" className="me-3 rounded" width="75" />
                        ...
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="form-group mb-3">
                              <label
                                htmlFor="author"
                                className="text-black font-w600 form-label"
                              >
                          ...
                          <div className="col-lg-12">
                            <div className="form-group">
                              <input
                                type="submit"
                                value="Post Comment"
                                className="submit btn btn-primary light"
                                id="submit"
                                name="submit"
                              />
                            </div>
