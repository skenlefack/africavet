                        ...
                        <div className="card card-bx profile-card author-profile m-b30">
                            ...
                            <div className="card-footer">
                                ...
                                <div className="input-group">
                                    <a href="https://www.dexignzone.com/" target="blank" className="form-control text-primary text-center rounded text-start bg-white">https://www.dexignzone.com/</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-xl-9 col-lg-8">
                    <div className="card profile-card card-bx m-b30">
                        ...
                        <form className="profile-form">
                            ...
                            <div className="card-footer">
                                <button className="btn btn-primary light">UPDATE</button>
                                <Link to={"#"} className="btn-link ms-3">Forgot your password?</Link>
                            </div>
                        </form>
                    </div>
                </div>
