...
const galleryBlog = [
	{image: IMAGES.Profile4}, {image: IMAGES.Profile3},
	{image: IMAGES.Profile2}, {image: IMAGES.Profile2},
									...
									<div className="card-body">
										<div className="profile-statistics">
											<div className="text-center">
												...
												<div className="mt-4">
													<Link to="/post-details" className="btn btn-primary light mb-1 me-1">Follow</Link>
													<Link to={"#"} className="btn btn-primary light mb-1 ms-1" onClick={() => dispatch({type:'sendMessage'})}>Send Message</Link>
												</div>
											</div>
								...
								<div className="card">
									...
									<div className="card-body">	
										<div className="profile-blog ">
											...
											<img  src={IMAGES.Profile1}  alt="profile" className="img-fluid mt-4 mb-4 w-100 rounded" />
											...
											<Tab.Pane id="my-posts"  eventKey='Posts'>
												<div className="my-post-content pt-3">
													<div className="post-input">
														...
														<Link to={"#"} className="btn btn-primary light ms-1" data-target="#postModal" onClick={() => dispatch({type:'postModal'})}>Post</Link>
													</div>
												...
												<div className="pt-3">
													<div className="settings-form">
														...
														<form onSubmit={(e) => e.preventDefault()}>
															...
															<button className="btn btn-primary light" type="submit">Sign in</button>
														</form>
													</div>
												</div>
											</Tab.Pane>
					...
					<div className="modal-body">
						<form className="comment-form" onSubmit={(e) => { e.preventDefault(); dispatch({type:'sendMessage'}); }}>
							<div className="row">
								...
								<div className="col-lg-12">
									<div className="form-group mb-3">
										<input type="submit" value="Post Comment" className="submit btn btn-primary light" name="submit"/>
									</div>
								</div>
							</div>
						</form>
			  ...
			  <Modal show={state.post} className="modal fade" id="postModal" onHide={() => dispatch({type:'postModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-body">
						...
						<Link className="btn btn-primary light light mt-2" to="/app-profile">Post</Link>
					</div>
				</div>
			</Modal>
			 {/* Link Modal */}
			  ...
			  <Modal   show={state.reply}  className="modal fade" id="replyModal" onHide={()=>dispatch({type:'replyModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-footer">
						...
						<button type="button" className="btn btn-primary light">Reply</button>
					</div>
				</div>
			</Modal>
		</Fragment>
