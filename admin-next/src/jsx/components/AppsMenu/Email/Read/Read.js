            ...
            <div className="card-body py-0">
                <div className="row gx-0">
                  <div className="col-xl-2 col-xxl-3">
                    <div className={`email-left-body ${openMailBar ? "active" : " "}`}>
                      <div className="email-left-box dz-scroll ps-0">
                        <div className="p-0">
                          <Link
                            to="/email-compose"
                        ...
                        <div className="email-right-box">
                            ...
                            <div className="row">
                              <div className="col-12">
                                <div className="right-box-padding dz-scroll p-3">                              
                                  <div className="read-wapper" id="read-content">
