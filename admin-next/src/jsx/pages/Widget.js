    ...
    <Fragment>      
        ...
        <div className="row">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <h6 className="mb-0">
                          ...
                          <strong className="text-danger">Sell $250</strong>
                        </h6>
                      </Link>
                    </li>
                    <li>
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="media-body">
                          <h5 className="mb-1">
                            ...
                            <span className="badge badge-warning light">Warning</span>
                          </h5>
                          <small className="d-block">
                            29 July 2022 - 02:26 PM
                          </small>
                    ...
                    <li>
                      <div className="timeline-panel">
                        ...
                        <div className="media-body">
                          ...
                          <Link
                            to="/widget-basic"
                            className="btn btn-primary btn-xxs shadow light"
                          >
                            Reply
                          </Link>
                          <Link
                            to="/widget-basic"
                            className="btn btn-danger light btn-xxs ms-1"
                          >
                            Delete
                          </Link>
                        </div>
                    ...
                    <li>
                      <div className="timeline-panel">
                        ...
                        <div className="media-body">
                          ...
                          <Link
                            to="/widget-basic"
                            className="btn btn-primary btn-xxs light shadow"
                          >
                            Reply
                          </Link>
                          <Link
          ...
          <div className="col-xl-3 col-lg-6 col-sm-6">
                            ...
                            <path opacity="0.3" fillRule="evenodd" clipRule="evenodd" d="M8 3V3.5C8 4.32843 8.67157 5 9.5 5H14.5C15.3284 5 16 4.32843 16 3.5V3H18C19.1046 3 20 3.89543 20 5V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V5C4 3.89543 4.89543 3 6 3H8Z" fill="#252525"></path>
                            <path fillRule="evenodd" clipRule="evenodd" d="M10.875 15.75C10.6354 15.75 10.3958 15.6542 10.2042 15.4625L8.2875 13.5458C7.90417 13.1625 7.90417 12.5875 8.2875 12.2042C8.67083 11.8208 9.29375 11.8208 9.62917 12.2042L10.875 13.45L14.0375 10.2875C14.4208 9.90417 14.9958 9.90417 15.3792 10.2875C15.7625 10.6708 15.7625 11.2458 15.3792 11.6292L11.5458 15.4625C11.3542 15.6542 11.1146 15.75 10.875 15.75Z" fill="#252525"></path>
                            <path fillRule="evenodd" clipRule="evenodd" d="M11 2C11 1.44772 11.4477 1 12 1C12.5523 1 13 1.44772 13 2H14.5C14.7761 2 15 2.22386 15 2.5V3.5C15 3.77614 14.7761 4 14.5 4H9.5C9.22386 4 9 3.77614 9 3.5V2.5C9 2.22386 9.22386 2 9.5 2H11Z" fill="#252525"></path>
													</g>
													<defs>
            ...
            <div className="widget-stat card">
              <div className="card-body p-4">
                <div className="media ai-icon">
                  <span className="me-3 bg-warning-light">
                    <svg
                      id="icon-orders"
                  ...
                  <div className="media-body">
                    ...
                    <span className="badge badge-warning light">+3.5%</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-3  col-lg-6 col-sm-6">
            <div className="widget-stat card">
              <div className="card-body  p-4">
                <div className="media ai-icon">
                  <span className="me-3 bgl-danger">
                    <svg
                      id="icon-revenue"
                      xmlns="http://www.w3.org/2000/svg"
                      width="30"
                  ...
                  <div className="media-body">
                    ...
                    <span className="badge badge-danger light">-3.5%</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-3  col-lg-6 col-sm-6">
            <div className="widget-stat card">
              <div className="card-body p-4">
                <div className="media ai-icon">
                  <span className="me-3 bgl-success">
                    <svg
                  ...
                  <div className="media-body">
                    ...
                    <h4 className="mb-0">364.50K</h4>
                    <span className="badge badge-success light">-3.5%</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="students1 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <div>
                    <div className="d-inline-block position-relative donut-chart-sale mb-3">                      
                      <DonutChart  value="62" backgroundColor="rgba(207, 248, 89,1)" backgroundColor2="rgba(245, 245, 245, 1)" />
                      <small>62%</small>
                    </div>
                  </div>
                </div>
            ...
            <div className="card">
              <div className="card-body">	
                <div className="students1 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <div>
                    <div className="d-inline-block position-relative donut-chart-sale mb-3">                     
                      <DonutChart  value="50" backgroundColor="rgba(255, 204, 192,1)" backgroundColor2="rgba(245, 245, 245, 1)" />
                      <small>38%</small>
                    </div>
                  </div>
                </div>
          ...
          <div className="col-xl-3  col-lg-6 col-sm-6">
            <div className="widget-stat card bg-danger-light">
              <div className="card-body  p-4">
                <div className="media">
                  <span className="me-3">
                    <i className="la la-users text-black"></i>
                  </span>
                  <div className="media-body">
                    <p className="mb-1 text-black">Total Students</p>
                    <h3 className="">3280</h3>
                    <div className="progress mb-2 bg-secondary">
                      <div
                        className="progress-bar progress-animated bg-black"
                        style={{ width: "80%" }}
                      ></div>
                    </div>
                    <small className="text-black">80% Increase in 20 Days</small>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-3  col-lg-6 col-sm-6">
            <div className="widget-stat card bg-warning-light">
              <div className="card-body p-4">
                <div className="media">
                  <span className="me-3">
                    <i className="la la-user text-black"></i>
                  </span>
                  <div className="media-body">
                    <p className="mb-1 text-black">New Students</p>
                    <h3 className="">245</h3>
                    ...
                    <small className="text-black">50% Increase in 25 Days</small>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-3  col-lg-6 col-sm-6">
            <div className="widget-stat card bg-danger-light ">
              <div className="card-body p-4">
                <div className="media">
                  <span className="me-3">
                    <i className="la la-dollar text-black"></i>
                  </span>
                  <div className="media-body">
                    <p className="mb-1 text-black">Fees Collect</p>
                    <h3 className="text-black">250$</h3>
                    <div className="progress mb-2 bg-secondary">
                      <div
                        className="progress-bar progress-animated bg-black"
                        style={{ width: "30%" }}
                    ...
                    <small className="text-black">30% Increase in 30 Days</small>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-12 col-lg-12 col-sm-12">
            <div className="row">
              <div className="col-xl-3 col-lg-6 col-sm-6">
                <div className="widget-stat card bg-primary-light">
                  <div className="card-header border-0 pb-0">
                    <h3 className="card-title text-black">Total Students</h3>
              ...
              <div className="col-xl-3 col-lg-6 col-sm-6">
                <div className="widget-stat card bg-danger-light overflow-hidden">
                  <div className="card-header border-0 ">
                    <h3 className="card-title text-black">New Students</h3>
                    <h5 className="text-black mb-0">
              ...
              <div className="col-xl-3 col-lg-6 col-sm-6">
                <div className="widget-stat card bg-danger-light overflow-hidden">
                  <div className="card-header pb-3 border-0 pb-0">
                    <h3 className="card-title text-black">Fees Collection</h3>
                    <h5 className="text-black mb-0">
          ...
          <div className="col-xl-4 col-lg-12 col-sm-12">
            <div className="card overflow-hidden">
              ...
              >
                ...
                <p className="text-black mb-0">Senior Manager</p>
              </div>
              <ul className="list-group list-group-flush">
              ...
              <div className="card-footer border-0 mt-0">
                <button className="btn btn-primary btn-lg light  btn-block">
                ...
                <table className="table verticle-middle table-responsive-md">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span className="badge badge-rounded badge-primary light">
                          Checkin
                        </span>
                      </td>
                      <td>$120</td>
                    ...
                    <tr>
                      ...
                      <td>31 July 2022</td>
                      <td>
                        <span className="badge badge-rounded badge-warning light">
                          Panding
                        </span>
                      </td>
                      <td>$540</td>
                    ...
                    <tr>
                      ...
                      <td>30 July 2022</td>
                      <td>
                        <span className="badge badge-rounded badge-danger light">
                          Canceled
                        </span>
                      </td>
                      <td>$301</td>
                    ...
                    <tr>
                      ...
                      <td>29 July 2022</td>
                      <td>
                        <span className="badge badge-rounded badge-success light">
                          Checkin
                        </span>
                      </td>
                      <td>$099</td>
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
            <div className="card text-white bg-primary-light">
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex justify-content-between">
          ...
          <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
            <div className="card text-white bg-warning-light text-black">
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex justify-content-between">
          ...
          <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
            <div className="card">
              <div className="card-body text-center ai-icon  text-primary">
                ...
                <Link className="btn my-2 btn-primary light btn-lg px-4">
            ...
            <div className="card overflow-hidden">
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h3 className="mt-3 mb-0 text-black">Deangelo Sena</h3>
              </div>
              <div className="card-body">
              ...
              <div className="card-footer mt-0">
                <button className="btn btn-primary btn-lg btn-block light">
                  View Profile
                </button>
              </div>
            </div>
