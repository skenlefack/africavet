		...
		<div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
			...
			<div className="sidebar-right-inner">
				...
				<div className="note-text">
					<span className="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://w3admin.dexignzone.com/react/doc"  rel="noreferrer"  target="_blank" className="text-primary">documentation.</a>
				</div>				
			</div>
		</div>
		...
		<div className={`dz-demo-panel ${demoToggle ? "show" : ""}`}>
			...
			<div className="dz-demo-inner">
				...
				<div className="note-text">
					...
					<a href="https://w3admin.dexignzone.com/react/doc"  rel="noreferrer"  target='_blank' className="text-primary"> documentation.</a>
				</div>
			</div>
		</div>
	</>
