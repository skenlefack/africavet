...
const MIGRATIONS = [
  ...
  '011_seed_newsletter_templates.sql',
  ...
  '019_create_ads_tables.sql',
  '020_update_ad_placements.sql',
  '021_update_category_colors.sql',
  '022_enhance_user_profiles.sql',
  '023_create_notifications_system.sql',
  '024_create_page_visits_table.sql',
  '025_add_smtp_settings.sql',
  '026_create_missing_tables.sql',
  '027_create_document_categories.sql',
  '028_create_documents.sql',
  '029_create_document_downloads.sql',
  '030_enhance_annuaire.sql',
  '031_add_module_permissions.sql',
  ...
  '052_create_annuaire_reports.sql',
  '053_add_opportunity_application_method.sql',
  '054_add_post_metadata_fields.sql',
  '055_create_authors.sql',
  '056_seed_authors.sql',
  '057_create_post_reviews.sql',
  '058_add_editorial_format.sql',
