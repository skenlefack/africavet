...
('site_email', 'contact@africavet.com', 'general'),
('site_phone', '+237 242 015 961', 'general'),
('site_address', 'Yaoundé, Cameroun', 'general'),
('posts_per_page', '12', 'reading'),
('default_post_status', 'draft', 'writing'),
('allow_comments', 'true', 'discussion'),
('comment_moderation', 'true', 'discussion'),
('primary_color', '#16a34a', 'appearance'),
('secondary_color', '#0ea5e9', 'appearance'),
('facebook_url', '', 'social'),
('twitter_url', '', 'social'),
('linkedin_url', '', 'social'),
('youtube_url', '', 'social'),
