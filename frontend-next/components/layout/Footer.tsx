...
export function Footer({ lang, t }: FooterProps) {
  ...
  const contact = {
    ...
    email: settings.contact_email || 'contact@africavet.com',
  };

  return (
    <footer className="bg-gradient-to-r from-[#3463b5] to-[#6faf4c] text-white">
      {/* Top Wave */}
      ...
      <div className="max-w-7xl mx-auto px-[5%] py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="text-xl font-extrabold tracking-wide">AFRICAVET</h3>
                <p className="text-xs text-emerald-300 font-semibold tracking-[0.2em]">
                  {lang === 'fr' ? 'MÉDECINE VÉTÉRINAIRE' : 'VETERINARY MEDICINE'}
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} AfricaVet. {t.footer.rights}.
          </p>
