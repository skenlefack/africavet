                                  ...
                                  <div className="mt-1">
                                    {photoPreview ? (
                                      <div className="relative w-32 h-32">
                                        <img src={photoPreview} alt="Preview" className="w-32 h-32 rounded-xl object-cover object-top border-2 border-gray-200" />
                                        <button
                                          type="button"
                                  ...
                                  <div className="mt-1">
                                    {materialImagePreview ? (
                                      <div className="relative w-40 h-40">
                                        <img src={materialImagePreview} alt="Preview" className="w-40 h-40 rounded-xl object-cover object-top border-2 border-gray-200" />
                                        <button
                                          type="button"
                                  ...
                                  <div className="mt-1">
                                    {docThumbnailPreview ? (
                                      <div className="relative w-40 h-28">
                                        <img src={docThumbnailPreview} alt="Thumbnail" className="w-40 h-28 rounded-xl object-cover object-top border-2 border-gray-200" />
                                        <button
                                          type="button"
