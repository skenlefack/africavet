...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: lang === 'fr'
      ? `Vérification Certificat ${code} | VET E-Learning`
      : `Certificate Verification ${code} | VET E-Learning`,
    description: lang === 'fr'
      ? 'Vérifiez l\'authenticité d\'un certificat VET E-Learning'
      : 'Verify the authenticity of an VET E-Learning certificate',
  };
}
      ...
      <section className="py-12 px-[5%]">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 text-center text-sm text-slate-500">
            <p>
              {language === 'fr'
                ? 'Les certificats VET E-Learning sont émis par One Health Cameroun et peuvent être vérifiés à tout moment sur cette page.'
                : 'VET E-Learning certificates are issued by One Health Cameroon and can be verified at any time on this page.'}
            </p>
          </div>
        </div>
      </section>
