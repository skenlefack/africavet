...
export default function CertificateVerifyLandingPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/${lang}/vet-elearning/certificate/verify/${encodeURIComponent(trimmedCode)}`);
  };
      ...
      <section className="py-12 px-[5%]">
        <div className="max-w-lg mx-auto">
          ...
          <div className="mt-6 text-center text-sm text-slate-500">
            <p>
              {language === 'fr'
                ? 'Les certificats VET E-Learning sont émis par One Health Cameroun et peuvent être vérifiés à tout moment.'
                : 'VET E-Learning certificates are issued by One Health Cameroon and can be verified at any time.'}
            </p>
          </div>
        </div>
      </section>
