...
export default function MyLearningPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      router.push(`/${lang}/auth/login?redirect=/${lang}/vet-elearning/my-learning`);
      return;
    }
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-blue-600 to-emerald-500 pt-24 pb-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-[5%]">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <Link
              href={`/${lang}/vet-elearning/my-learning/certificates`}
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {continueLearning.filter(e => e.slug).map((enrollment) => {
                ...
                const courseUrl = enrollment.enrollable_type === 'course'
                  ? `/${lang}/vet-elearning/learn/${enrollment.slug}`
                  : `/${lang}/vet-elearning/paths/${enrollment.slug}`;
                      ...
                      <div className="flex-shrink-0">
                        {enrollment.status === 'completed' ? (
                          enrollment.certificate_id ? (
                            <Link href={`/${lang}/vet-elearning/my-learning/certificates`}>
