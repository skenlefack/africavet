...
export default function MyCertificatesPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      router.push(`/${lang}/login?redirect=/${lang}/vet-elearning/my-learning/certificates`);
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-500 to-rose-500 pt-24 pb-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-[5%]">
          {/* Back link */}
          <Link
            href={`/${lang}/vet-elearning/my-learning`}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link
                        href={`/${lang}/vet-elearning/certificate/verify/${cert.verification_code}`}
                        className="flex-1"
                      >
