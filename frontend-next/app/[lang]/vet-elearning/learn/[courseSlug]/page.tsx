            ...
            if (hasNoModules && hasFinalQuiz) {
              ...
              if (!hasRedirected.current && curriculumRes.data.modules.length > 0) {
                ...
                if (continueLesson) {
                  ...
                  router.replace(`/${lang}/vet-elearning/learn/${courseSlug}/${continueLesson.id}`);
                  return;
                }
              }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/${lang}/vet-elearning/courses`}>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <header className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white pt-28 pb-12 px-[5%]">
          <div className="max-w-4xl mx-auto">
            <Link
              href={`/${lang}/vet-elearning/courses/${courseSlug}`}
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                    <Link href={`/${lang}/vet-elearning/certificate/verify/${certificate.verification_code}`}>
              ...
              <div className="text-center">
                {!token ? (
                  <div>
                    ...
                    <Link href={`/${lang}/auth/login?redirect=${encodeURIComponent(`/${lang}/vet-elearning/learn/${courseSlug}`)}`}>
                  ...
                  <div>
                    ...
                    {canRetake && (
                      <Link href={`/${lang}/vet-elearning/quiz/${course.final_quiz_id}`}>
                  ...
                  .map((attempt, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <Link href={`/${lang}/vet-elearning/quiz/${course.final_quiz_id}/results/${attempt.id}`}>
                ...
                {expandedModules.has(module.id) && module.lessons && (
                  <div className="ml-4 pl-4 border-l-2 border-slate-100">
                    {module.lessons.map((lesson, lessonIdx) => (
                      <Link
                        key={lesson.id}
                        href={`/${lang}/vet-elearning/learn/${courseSlug}/${lesson.id}`}
                        className={cn(
        ...
        >
          <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
              ...
              {firstLesson && (
                <Link href={`/${lang}/vet-elearning/learn/${courseSlug}/${firstLesson.id}`}>
                  <Button variant="primary" size="lg" className="bg-blue-600 hover:bg-blue-700">
                    <Play size={20} className="mr-2" />
                    {t.elearning.start}
                  </Button>
