    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-900 text-white">
        <div className="text-center">
          ...
          <Link href={`/${lang}/vet-elearning/courses/${courseSlug}`}>
        ...
        <div className="fixed inset-0 bg-black/70 z-[110] flex items-center justify-center p-4">
          <div className="bg-slate-800 rounded-xl p-6 max-w-md w-full">
            ...
            <div className="flex gap-3">
              ...
              <Link href={`/${lang}/vet-elearning/login?redirect=${encodeURIComponent(window.location.pathname)}`} className="flex-1">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="flex items-center justify-between py-6 border-t border-slate-700">
              {prevLesson ? (
                <Link href={`/${lang}/vet-elearning/learn/${courseSlug}/${prevLesson.id}`}>
              ...
              {nextLesson ? (
                <Link href={`/${lang}/vet-elearning/learn/${courseSlug}/${nextLesson.id}`}>
