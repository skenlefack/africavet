...
export const translations: Record<Language, Translation> = {
  fr: {
    nav: {
      ...
      getTrained: 'Se former',
      find: 'Trouver',
      opportunities: 'Opportunités',
      coordinate: 'Se coordonner',
    },
    fivePillars: {
      getInformed: {
        title: "S'informer",
        description: 'Actualités, articles et analyses sur la médecine vétérinaire en Afrique',
        items: {
          news: 'Actualités',
          articles: 'Articles',
          analysis: 'Analyses',
      ...
      getTrained: {
        title: 'Se former',
        description: 'VET E-Learning - Formations en ligne pour les professionnels vétérinaires',
        items: {
          courses: 'Cours',
      ...
      find: {
        title: 'Trouver',
        description: 'VET LINK - Annuaire vétérinaire panafricain',
        items: {
          clinics: 'Cliniques & Hôpitaux',
          laboratories: 'Laboratoires',
          pharmacies: 'Pharmacies',
          emergencies: 'Urgences',
          schools: 'Écoles & Formations',
          officials: 'Services officiels',
        },
      },
      opportunities: {
        title: 'Opportunités',
        description: 'Emplois, appels d\'offres et marchés vétérinaires',
        items: {
          jobs: 'Emplois',
      ...
      coordinate: {
        title: 'Se coordonner',
        description: 'VET Alert - Alertes sanitaires et coordination communautaire',
        items: {
          alerts: 'Alertes sanitaires',
          events: 'Événements',
          community: 'Communauté',
          reportAlert: 'Signaler une alerte',
        },
      },
    },
    hero: {
  ...
  en: {
    ...
    fivePillars: {
      getInformed: {
        title: 'Get Informed',
        description: 'News, articles and analysis on veterinary medicine in Africa',
        items: {
          news: 'News',
          articles: 'Articles',
          analysis: 'Analysis',
      ...
      getTrained: {
        title: 'Get Trained',
        description: 'VET E-Learning - Online training for veterinary professionals',
        items: {
          courses: 'Courses',
      ...
      find: {
        title: 'Find',
        description: 'VET LINK - Pan-African veterinary directory',
        items: {
          ...
          officials: 'Official Services',
        },
      },
      opportunities: {
        title: 'Opportunities',
        description: 'Jobs, tenders and veterinary markets',
        items: {
          jobs: 'Jobs',
          tenders: 'Tenders',
          markets: 'Markets',
      ...
      coordinate: {
        title: 'Coordinate',
        description: 'VET Alert - Health alerts and community coordination',
        items: {
          alerts: 'Health Alerts',
          events: 'Events',
          community: 'Community',
          reportAlert: 'Report an Alert',
        },
      },
    },
    hero: {
